...
if L == 1
    ...
    if r > 29
        pause(0.5)
        disp('The sound of zombie’s footsteps can be heard, with each step being louder. You painfully hold your breath and pray to the heavens.')
        pause(0.5)
        ...
        pause(0.5)
        disp('The door proves no match to the might of the zombie, is it soon broken down with you being devoured soon after.')
        pause(0.5)
        death
    end
elseif L == 2
