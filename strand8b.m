...
disp('                                                         ')
pause(0.5)
disp('You make your way onwards to Battersea Power Station and hear screams. ')
pause(1.5)
...
disp(' ')
if L == 1;
   disp('You shoot the two zombies in the head, but you take about 50 bullets to do it. ')
   pause(1.5)
   disp('You are running low on ammo now, better be careful in future.')
   pause(1.5)
   strand9b
elseif L == 2;
